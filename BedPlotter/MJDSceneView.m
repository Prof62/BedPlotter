...
- (void) updateUI
{
    ...
    bedMaterial.transparency = showBed?0.1f:0.0f;
    ...
    planeMaterial.transparency = 0.3f;
        ...
        if(showPlane)
            ...
            for (int y = 0; y < 7; y++)
                ...
                for (int x = 0; x < 7; x++)
                    ...
                    normals[ ( y * 7 ) + x + 49 ] = SCNVector3Make((x1-3) * (8.5f/4.0f), (points[y1][x1] * 10.f), (y1-3) * (8.5f/4.0f));
